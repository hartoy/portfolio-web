...
const Home = () => {
  return (
    <div className="container flex flex-col md:flex-row px-4 mx-auto md:px-8 lg:max-w-7xl mt-[90px] md:mt-[140px] md:mb-[140px] md:items-center">
      ...
      <div className="info ">
        ...
        <div className="socials flex items-center justify-around md:w-[70%] md:justify-around mt-[30px] mb-0 md:mb-[50px]">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="text-gray-900 md:w-[150px] md:h-[40px] bg-[#DBE2EF] hover:bg-[#F9F7F7] focus:ring-4 focus:outline-none focus:[#3F72AF] dark:focus:[#3F72AF] shadow-lg shadow-[#3F72AF] dark:shadow-lg dark:shadow-[#3F72AF] font-medium rounded-lg text-sm px-5 py-2.5 text-center uppercase text-[#3F72AF]"
          >
            Contact Me
          </motion.button>
        </div>
